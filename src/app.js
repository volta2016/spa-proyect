...
const showModalLogin = () => openLogin.addEventListener('click', handleEventModalLogin);

const hideModalLogin = () => closeLogin.addEventListener('click', handleEventModalLogin);
